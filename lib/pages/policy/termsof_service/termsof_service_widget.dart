                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  'Welcome to 4sh (“the App”). By accessing or using our platform, you agree to comply with and be bound by the following Terms of Service (“Terms”). If you do not agree with these Terms, please do not use the App.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  '4.1 The App provides educational content tailored for various standard entrance examinations in India.\n4.2 You agree to use the App solely for personal, non-commercial purposes and in compliance with applicable laws.\n4.3 You may not:\n',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                            ...
                                            TextSpan(
                                              text:
                                                  '• Copy, distribute, or modify any part of the App without authorization.\n',
                                              style: TextStyle(),
                                            ),
                                            TextSpan(
                                              text:
                                            ...
                                            TextSpan(
                                              text:
                                                  '• Interfere with the App’s functionality, including security features.',
                                              style: TextStyle(),
                                            )
                                          ],
                                          style: FlutterFlowTheme.of(context)
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  '6.1 Certain features or content may require a subscription or one-time payment.\n6.2 All payments are non-refundable unless otherwise specified.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  '11.1 These Terms are governed by the laws of India. Disputes will be resolved in the courts of Bengaluru, India.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
