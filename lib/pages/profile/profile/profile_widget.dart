                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      16.0, 12.0, 16.0, 0.0),
                                              child: StreamBuilder<
                                                  List<ConstantDataRecord>>(
                                                stream: queryConstantDataRecord(
                                                  singleRecord: true,
                                                ),
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<ConstantDataRecord>
                                                      wACommunityConstantDataRecordList =
                                                      snapshot.data!;
                                                  // Return an empty Container when the item does not exist.
                                                  if (snapshot.data!.isEmpty) {
                                                    return Container();
                                                  }
                                                  final wACommunityConstantDataRecord =
                                                      wACommunityConstantDataRecordList
                                                              .isNotEmpty
                                                          ? wACommunityConstantDataRecordList
                                                              .first
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'PROFILE_PAGE_DeleteAccountt_ON_TAP');
                                                  logFirebaseEvent(
                                                      'DeleteAccountt_bottom_sheet');
                                                    ...
                                                    children: [
                                                      Align(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'PROFILE_PAGE_uploadVideo_ON_TAP');
                                                            logFirebaseEvent(
                                                                'uploadVideo_bottom_sheet');
                                                            await showModalBottomSheet(
                                                              isScrollControlled:
                                                                  true,
                                                              backgroundColor:
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'PROFILE_PAGE_Text_i3e4z17d_ON_TAP');
                                                logFirebaseEvent(
                                                    'Text_navigate_to');
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'PROFILE_PAGE_Text_imv1rou4_ON_TAP');
                                                logFirebaseEvent(
                                                    'Text_navigate_to');
