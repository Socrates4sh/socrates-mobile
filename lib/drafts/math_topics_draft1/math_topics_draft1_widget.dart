...
import 'math_topics_draft1_model.dart';
export 'math_topics_draft1_model.dart';

class MathTopicsDraft1Widget extends StatefulWidget {
  const MathTopicsDraft1Widget({super.key});

  static String routeName = 'MathTopicsDraft1';
  static String routePath = '/mathTopicsDraft1';

  @override
  State<MathTopicsDraft1Widget> createState() => _MathTopicsDraft1WidgetState();
}

class _MathTopicsDraft1WidgetState extends State<MathTopicsDraft1Widget> {
  late MathTopicsDraft1Model _model;
