...
import 'subjects_copy_model.dart';
export 'subjects_copy_model.dart';

class SubjectsCopyWidget extends StatefulWidget {
  const SubjectsCopyWidget({
    super.key,
    required this.exam,
    this.grade,
  });
  ...
  static String routeName = 'SubjectsCopy';
  static String routePath = '/subjectsCopy';

  @override
  State<SubjectsCopyWidget> createState() => _SubjectsCopyWidgetState();
}

class _SubjectsCopyWidgetState extends State<SubjectsCopyWidget> {
  late SubjectsCopyModel _model;
                          ...
                          child: Align(
                            ...
                            child: StreamBuilder<List<SubjectsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<SubjectsRecord>
                                    gridViewSubjectsRecordList = snapshot.data!;
