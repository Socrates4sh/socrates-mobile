...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF192452);
  late Color secondary = const Color(0xFFACB9DA);
  late Color tertiary = const Color(0xFF247B7B);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFCFCFE);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFFEAD637);
  late Color success = const Color(0xFF85CB33);
  late Color warning = const Color(0xFFEAD637);
  late Color error = const Color(0xFFA31621);
  late Color info = const Color(0xFFFFFFFF);

  late Color customColor1 = const Color(0xFFEE964B);
  late Color customColor2 = const Color(0xFF7687AE);
  late Color customColor3 = const Color(0xFFE4C3AD);
  late Color customColor4 = const Color(0xFFE3D5A5);
  late Color customColor5 = const Color(0xFF1109E7);
  late Color customColor6 = const Color(0xFF3F9F39);
  late Color customColor7 = const Color(0xFF2A2D3E);
}
